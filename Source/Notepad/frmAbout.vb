...
Public NotInheritable Class frmAbout
    ...
    Private Sub AboutBox1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.LinkLabel2.Links(0).LinkData = Me.LinkLabel2.Text
        Me.LinkLabel3.Links(0).LinkData = Me.LinkLabel3.Text
        Me.LinkLabel4.Links(0).LinkData = Me.LinkLabel4.Text
        Me.LinkLabel5.Links(0).LinkData = Me.LinkLabel5.Text
        Me.LinkLabel6.Links(0).LinkData = Me.LinkLabel6.Text
    ...
    End Sub
    Private Sub LinkLabel6_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkLabel6.LinkClicked, LinkLabel4.LinkClicked, LinkLabel5.LinkClicked, LinkLabel2.LinkClicked, LinkLabel3.LinkClicked
        Dim target As String = CType(e.Link.LinkData, String)
        System.Diagnostics.Process.Start("mailto:" & target) ' ."linhhonglecao@gmail.com")
    End Sub
